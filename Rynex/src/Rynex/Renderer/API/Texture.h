...
namespace Rynex {
	...
	class RYNEX_API StoreTextureArray : public Asset
	{
	public:
		static Ref<StoreTextureArray> Create(TextureSpecification spec);
		virtual ~StoreTextureArray() {};
		...
		virtual void BindArray(uint32_t slot = 0) const = 0;
		virtual void BindImageArray(Acces acces, uint32_t slot = 0) const = 0;
		virtual void UnBindArray(uint32_t slot = 0) const = 0;
		virtual void UnBindImageArray(Acces acces, uint32_t slot = 0) const = 0;

		virtual void BindTextureIndex(uint32_t slot = 0, uint32_t textureIndex) const = 0;
		virtual void BindImageTextureIndex(Acces acces, uint32_t slot = 0, uint32_t textureIndex) const = 0;
		virtual void UnBindTextureIndex(uint32_t slot = 0) const = 0;
		virtual void UnBindImageTextureIndex(Acces acces, uint32_t slot = 0) const = 0;


		virtual void ResizeTextureArray(int size) = 0;
		...
		virtual const TextureSpecification& GetSpecification() const = 0;
		virtual bool operator==(const StoreTextureArray& other) const = 0;

		static AssetType GetStaticType() { return AssetType::StoreTextureArray; }
		AssetType GetType() const { return GetStaticType(); }
	};
#endif
#if 0
	class RYNEX_API Texture1D : public Texture
	{
	public:
		static Ref<Texture1D> Create1D(TextureSpecification spec, void* data, uint32_t size);
		static Ref<Texture1D> CreateAsync1D(TextureSpecification spec, std::vector<unsigned char>&& data);
		static Ref<Texture1D> Create1D(TextureSpecification spec);
	...
	class RYNEX_API Texture2D : public Texture
	{
	public:
		static Ref<Texture2D> Create2D(TextureSpecification spec, void* data, uint32_t size);
		static Ref<Texture2D> CreateAsync2D(TextureSpecification spec, std::vector<unsigned char>&& data);
		static Ref<Texture2D> Create2D(TextureSpecification spec);
	...
	class RYNEX_API Texture3D : public Texture
	{
	public:
		static Ref<Texture3D> Create3D(TextureSpecification spec, void* data, uint32_t size);
		static Ref<Texture3D> CreateAsync3D(TextureSpecification spec, std::vector<unsigned char>&& data);
		static Ref<Texture3D> Create3D(TextureSpecification spec);
	...
	class RYNEX_API TextureCubeMap : public Texture
	{
	public:
		...
		static Ref<TextureCubeMap> CreateCubeMap(TextureSpecification spec, void* data, uint32_t size);
		static Ref<TextureCubeMap> CreateAsyncCubeMap(TextureSpecification spec, std::vector<unsigned char>&& data);
		static Ref<TextureCubeMap> CreateCubeMap(TextureSpecification spec);
		...
		virtual void Resize2D(uint32_t width, uint32_t height) = 0;
		static void BindTexCubeMap(uint32_t renderID, uint32_t slot = 0);
