...
namespace Rynex {
	...
	struct ScriptingEngineData
	{
		...
		MonoAssembly* CoreAssambly = nullptr;
	};
	...
	void ScriptingEngine::InitMono()
	{
		...
		s_Data->CoreAssambly = LoadCSharpAssembly("Resources/Scripts/Rynex-ScriptingCore.dll");
		PrintAssemblyTypes(s_Data->CoreAssambly);
	}
